...
document.addEventListener("keydown", function(event) {
    // Check if Ctrl and Delete keys are pressed simultaneously
    if (event.ctrlKey && event.key === "Delete") {
        // Assuming you're using local storage to store your data
        // You can clear the data stored in local storage like this:
        localStorage.removeItem("studentData");
        // Optionally, you can provide feedback to the user that the data has been deleted
